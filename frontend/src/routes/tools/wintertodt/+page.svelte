<script lang="ts">
    ...
    interface ProTipsData {
        ...
        reward_calculation: {
            crates_per_round: string;
            loot_variation: string;
    ...
    async function loadProTips() {
        ...
        try {
            const response = await fetch('http://localhost:8080/api/tools/wintertodt/tips');
            if (!response.ok) {
    ...
    <div class="max-w-4xl mx-auto mt-12">
        <div class="bg-theme-bg-secondary rounded-card border border-theme-border-accent/20 shadow-card overflow-hidden">
            <button 
                ...
                class="w-full px-6 py-4 text-left bg-gradient-to-r from-orange-500/10 via-red-500/5 to-transparent hover:from-orange-500/15 hover:via-red-500/10 transition-all duration-200 flex items-center justify-between group"
            >
                <div class="flex items-center space-x-3">
                    <div class="w-8 h-8 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-theme-text-secondary">Learn how Wintertodt XP rates and rewards are calculated</p>
                    </div>
                </div>
                <svg 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-theme-text-secondary">
                                            <strong>Rounds per Hour:</strong> {proTipsData.game_mechanics.rounds_per_hour}
                                        </p>
                                    </div>
                                    <div>
                        ...
                        <div>
                            ...
                            <div class="bg-theme-bg-primary/50 rounded-lg p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <p class="text-sm text-theme-text-secondary mb-2">
                                            <strong>Crates per Round:</strong> {proTipsData.reward_calculation.crates_per_round}
                                        </p>
                                        <p class="text-sm text-theme-text-secondary">
                                            <strong>Loot Variation:</strong> {proTipsData.reward_calculation.loot_variation}
                                        </p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-theme-text-secondary mb-2">
                                        ...
                                        <p class="text-sm text-theme-text-secondary">
                                            <strong>GP Calculation:</strong> {proTipsData.reward_calculation.gp_calculation}
                                        </p>
                                    </div>
                                </div>
                            </div>
