<script lang="ts">
    ...
    function handleCalculation(event: CustomEvent<{ resultData: WintertodtApiResult }>) {
...
<div class="max-w-6xl mx-auto">
    ...
    <header class="mb-10 text-center">
        <h1 class="text-h1 text-theme-text-primary tracking-tight mt-10">Wintertodt Calculator</h1>
